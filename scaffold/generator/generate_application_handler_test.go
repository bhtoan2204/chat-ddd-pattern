	...
	cases := []applicationHandlerTemplateData{
		{
			...
			RequestDtoImport:  "wechat-clone/core/modules/payment/application/dto/in",
			ResponseDtoImport: "wechat-clone/core/modules/payment/application/dto/out",
			CQRSImport:        "wechat-clone/core/shared/pkg/cqrs",
			Imports: []applicationHandlerImport{
				{Alias: "appCtx", Path: "wechat-clone/core/context"},
				{Alias: "repos", Path: "wechat-clone/core/modules/payment/domain/repos"},
				{Path: "wechat-clone/core/modules/payment/application/service"},
			},
		...
		},
		{
			...
			RequestDtoImport:  "wechat-clone/core/modules/account/application/dto/in",
			ResponseDtoImport: "wechat-clone/core/modules/account/application/dto/out",
			CQRSImport:        "wechat-clone/core/shared/pkg/cqrs",
			Imports: []applicationHandlerImport{
				{Alias: "appCtx", Path: "wechat-clone/core/context"},
				{Path: "wechat-clone/core/modules/account/application/service"},
				{Alias: "repos", Path: "wechat-clone/core/modules/account/domain/repos"},
			},
			Params: []applicationHandlerParam{
				{Name: "appCtx", Type: "*appCtx.AppContext"},
				{Name: "baseRepo", Type: "repos.Repos"},
		...
		},
		{
			...
			RequestDtoImport:  "wechat-clone/core/modules/room/application/dto/in",
			ResponseDtoImport: "wechat-clone/core/modules/room/application/dto/out",
			CQRSImport:        "wechat-clone/core/shared/pkg/cqrs",
			Imports: []applicationHandlerImport{
				{Alias: "appCtx", Path: "wechat-clone/core/context"},
				{Alias: "repos", Path: "wechat-clone/core/modules/room/domain/repos"},
				{Path: "wechat-clone/core/modules/room/application/service"},
			},
			Params: []applicationHandlerParam{
				{Name: "appCtx", Type: "*appCtx.AppContext"},
