...
type RebuildProjectionHandler = cqrs.Handler[*in.RebuildProjectionRequest, *out.RebuildProjectionResponse]
...
func NewBus(depositHandler DepositHandler, rebuildProjectionHandler RebuildProjectionHandler, transferHandler TransferHandler, withdrawalHandler WithdrawalHandler) Bus {
	return Bus{
		Deposit:           cqrs.NewDispatcher(depositHandler),
		RebuildProjection: cqrs.NewDispatcher(rebuildProjectionHandler),
